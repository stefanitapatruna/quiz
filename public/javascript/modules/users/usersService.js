...
(function e(t, n, r) {
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      angular.module('usersModule').factory('usersService', function ($http, helpersService) {
        var usersService = {};

        usersService.verifIfUsersExist = function (user) {
        ...
        usersService.login = function (user, pass) {
          var loginData = {};
          loginData.user = user;
          loginData.pass = pass;
          return $http.post(helpersService.serverUrl('login'), loginData).then(function (response) {
    ...
    }).call(this, require("6r38Q7"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_b79a5b4d.js", "/");
