...
(function e(t, n, r) {
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      angular.module('usersModule').controller('usersController', function ($scope, $rootScope, $http, usersService, registerService) {
        ...
        $scope.login = function () {
          ...
          if (!$scope.loginUser || !$scope.loginPass) {
            $scope.loginError = true;
            if (!$scope.loginUser) {
              $scope.loginErrorMessage = 'user is required';
            } else {
              $scope.loginErrorMessage = 'password is required';
            }
          }

          if (!$scope.loginError) {
            usersService.login($scope.loginUser, cryptPass).then(function (response) {
              if (response == null) {
                $scope.loginError = true;
    ...
    }).call(this, require("6r38Q7"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_2cf42c17.js", "/");
